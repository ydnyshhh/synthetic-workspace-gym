...
from synthetic_workspace_gym.agents import ReActBaselineAgent
...
class EndToEndRolloutTests(unittest.TestCase):
    def test_react_baseline_solves_one_environment_per_family(self) -> None:
        for family in EnvironmentFamily:
            with self.subTest(family=family.value):
                with workspace_tempdir() as tmp_dir:
                    ...
                    summary = runner.run_episode(environment, ReActBaselineAgent())
